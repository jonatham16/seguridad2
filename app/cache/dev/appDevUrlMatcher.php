...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // molinaseguridad_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'molinaseguridad_homepage')), array (  '_controller' => 'molina\\seguridadBundle\\Controller\\DefaultController::indexAction',));
        }

        // paginaprotegida
        if ($pathinfo === '/perfil/paginaprotegida') {
